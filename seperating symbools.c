...
int main()
{
    ...
    while(fscanf(open_file,"%c",&extract)!=EOF)
    {
        ...
        if(extract==' '||extract=='('||extract=='{')
        {
            ...
            if(strcmp("int",keywords)||strcmp("double",keywords)||strcmp("float",keywords)||strcmp("char",keywords)||strcmp("for",keywords)||strcmp("if",keywords)||strcmp("else",keywords)||strcmp("while",keywords))
            {
